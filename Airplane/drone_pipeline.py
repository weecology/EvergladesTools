...
def iterate(checkpoint_dir, images_to_annotate_dir, annotated_images_dir, test_csv, user, host, folder_name, key_filename, patch_size, patch_overlap, model_checkpoint=None, annotation_csv=None):
    ...
    if complete:
        ...
        # Predict images
        preannotations = model.predict(m, images, patch_size=400, patch_overlap=0.05)
        
        # Upload images to annotation platform
        label_studio_project = upload.connect_to_label_studio(url="https://labelstudio.naturecast.org/", project_name="everglades-annotation")
